...
<html lang="en">
 <head>
  <title>Akari Yoshino: Contact Form</title>
 ...
 <body>
     <header>
     <h1>Akari Yoshino: Contact Form</h1>
     <nav class="topnav" id="myTopnav">
       ...
       <a href="contact.php" class="active">Contact Akari</a>
   ...
   <div class="wrapper">
       ...
       <h2 class="subheader">Contact Akari</h2>
       ...
       <?php
        ...
        $toAddress = "lululuntea@gmail.com";  //place your/your client's email address here
